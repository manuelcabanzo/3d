...
const Contact = () => {
  ...
  const [form, setform] = useState({
    ...
    const handleSubmit = (e) => {
      ...
      'template_oftag9n',
      {
        ...
        to_email: 'manuelcabanzo23@gmail.com',
  ...
  return (
    <div className='xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden'>
      <motion.div
        variants={slideIn('left', 'btweeen', 0.2, 1 )}
      ...
      >
        ...
        >
          ...
          <label className='flex flex-col'>
            ...
            <textarea rows="7"type="text" name='message'  value={form.message} onChange={handleChange} placeholder='What do you want to say?' className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outlined-none border-none font-medium'/>
      ...
      <motion.div 
        variants={slideIn('right', 'btweeen', 0.2, 1 )}
